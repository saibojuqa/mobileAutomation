...
public class ManagePage extends BasePage {
    ...
    private static final String HIRED_AT_WITH_DATE = "com.peoplematter.android:id/contact_details_milestone_name";
    ...
    public ManagePage verifyHiredAtWithPlaceAndDate() {
        ...
        getfd().element(By.id(HIRED_AT_WITH_DATE)).waitUntil(MAX_TIME).ifElementIsNotDisplayed().isDisplayed();
        return this;
    }
