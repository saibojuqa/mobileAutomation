...
public class RecruitingPage extends BasePage {
    ...
    private static final String AUTOMATE_MOBILE_TEXT = "//android.widget.TextView[@text='AutomateMobile']";
    private static final String APPLICANT_0 = "//android.widget.TextView[@text='Applicants (0)']";
    private static final String APPLICANT_1 = "//android.widget.TextView[@text='Applicants (1)']";
    ...
    public RecruitingPage clickOnAutomateMobileRequisitionandVerifyApplicant0() {
        getfd().element(By.xpath(AUTOMATE_MOBILE_TEXT)).waitUntil(MAX_TIME).ifElementIsNotDisplayed().click();
        getfd().element(By.xpath(APPLICANT_0)).waitUntil(MAX_TIME).ifElementIsNotDisplayed().isDisplayed();
        return this;
    }

    public RecruitingPage clickOnAutomateMobileRequisitionandVerifyApplicant1() {
        getfd().element(By.xpath(AUTOMATE_MOBILE_TEXT)).waitUntil(MAX_TIME).ifElementIsNotDisplayed().click();
        getfd().element(By.xpath(APPLICANT_1)).waitUntil(MAX_TIME).ifElementIsNotDisplayed().isDisplayed();
        return this;
    }
