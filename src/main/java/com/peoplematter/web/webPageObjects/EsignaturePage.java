 ...
 */
public class EsignaturePage extends BasePage {
    ...
    public EqualEmploymentPage clickOnESIGNATUREANDTERMS() throws InterruptedException {
        Thread.sleep(3000);
        ...
        return new EqualEmploymentPage();
    }
