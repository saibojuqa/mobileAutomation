 ...
 */
public class HowMuchToGetPaidPage10 extends BasePage{
    ...
    public TellUsAboutYourselfPage11 enterDetails(UserDetails userDetails) {
        ...
        return new TellUsAboutYourselfPage11();
